...
/*   Updated: 2024/02/01 19:27:57 by fwatanab         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	prompt_name(int index, std::string f_name, std::string l_name, std::string n_name, std::string nbr){
	...
	std::cout << "|" << std::right << std::setw(10) << index \
		<< "|" << std::right << std::setw(10) << f_name \
		<< "|" << std::right << std::setw(10) << l_name \
		<< "|" << std::right << std::setw(10) << n_name \
		<< "|" << std::right << std::setw(10) << nbr << "|" << std::endl;
}
